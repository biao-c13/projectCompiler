...
public interface FOOLVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by the {@code assegnamentoExp}
	 * labeled alternative in {@link FOOLParser#prog}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitAssegnamentoExp(FOOLParser.AssegnamentoExpContext ctx);
	/**
	 * Visit a parse tree produced by the {@code classDichiarazione}
	 * labeled alternative in {@link FOOLParser#prog}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitClassDichiarazione(FOOLParser.ClassDichiarazioneContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by the {@code assegnamento}
	 * labeled alternative in {@link FOOLParser#stm}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitAssegnamento(FOOLParser.AssegnamentoContext ctx);
	/**
	 * Visit a parse tree produced by the {@code assegnamentoMethod}
	 * labeled alternative in {@link FOOLParser#stm}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitAssegnamentoMethod(FOOLParser.AssegnamentoMethodContext ctx);
	/**
	 * Visit a parse tree produced by the {@code codizione}
	 * labeled alternative in {@link FOOLParser#stm}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitCodizione(FOOLParser.CodizioneContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link FOOLParser#notFunDec}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitNotFunDec(FOOLParser.NotFunDecContext ctx);
	/**
